...
public class MockCatalogReaderSimple extends MockJdbcCatalogReader {
    ...
    /**
     * Register/create the sales schema
     */
    void registerSalesSchema() {
    ...
    /**
     * https://docs.oracle.com/en/database/oracle/oracle-database/12.2/comsc/OE-sample-schema-table-descriptions.html#GUID-1B906F5E-64BA-4C93-8FCC-0F3F96E9B9C1
     */
    void registerOeOrderEntrySchema() {

        // Register "Order Entry (OE)" schema.
        MockSchema orderEntrySchema = new MockSchema("OE");
        registerSchema(orderEntrySchema);

        // Register "Order" table.
        MockTable orderTable = MockTable.create(this, orderEntrySchema, "ORDERS",
                false, 200D);
        orderTable.addColumn("ORDER_ID", fixture.intType);
        orderTable.addColumn("ORDER_DATE", fixture.dateType);
        orderTable.addColumn("ORDER_MODE", fixture.varchar10TypeNull);
        orderTable.addColumn("CUSTOMER_ID", fixture.intType);
        orderTable.addColumn("ORDER_STATUS", fixture.intTypeNull);
        orderTable.addColumn("ORDER_TOTAL", fixture.intTypeNull);
        orderTable.addColumn("SALES_REP_ID", fixture.intTypeNull);
        orderTable.addColumn("PROMOTION_ID", fixture.intTypeNull);
        registerTable(orderTable);

        // Register "Order" table.
        MockTable customersTable = MockTable.create(this, orderEntrySchema, "CUSTOMERS",
                false, 200D);
        customersTable.addColumn("CUSTOMER_ID", fixture.intType);
        customersTable.addColumn("CUST_FIRST_NAME", fixture.varchar20Type);
        customersTable.addColumn("CUST_LAST_NAME", fixture.varchar20Type);
        customersTable.addColumn("CUST_ADDRESS", fixture.varchar20Type);
        customersTable.addColumn("PHONE_NUMBERS", fixture.varchar20Type);
        customersTable.addColumn("NLS_LANGUAGE", fixture.varchar5Type);
        customersTable.addColumn("NLS_TERRITORY", fixture.varchar20Type);
        customersTable.addColumn("CREDIT_LIMIT", fixture.intType);
        customersTable.addColumn("CUST_EMAIL", fixture.varchar20Type);
        customersTable.addColumn("ACCOUNT_MGR_ID", fixture.intType);
        customersTable.addColumn("CUST_GEO_LOCATION", fixture.varchar20Type);
        customersTable.addColumn("DATE_OF_BIRTH", fixture.dateType);
        customersTable.addColumn("MARITAL_STATUS", fixture.varchar20Type);
        customersTable.addColumn("GENDER", fixture.varchar5Type);
        customersTable.addColumn("INCOME_LEVEL", fixture.varchar5Type);
        registerTable(customersTable);

      // Register "Order" table.
      MockTable orderItemsTable = MockTable.create(this, orderEntrySchema, "ORDERS_ITEM",
              false, 200D);
      orderItemsTable.addColumn("ORDER_ID", fixture.intType);
      orderItemsTable.addColumn("LINE_ITEM_ID", fixture.intType);
      orderItemsTable.addColumn("PRODUCT_ID", fixture.intType);
      orderItemsTable.addColumn("CUSTOMER_ID", fixture.intType);
      orderItemsTable.addColumn("UNIT_PRICE", fixture.intTypeNull);
      orderItemsTable.addColumn("QUANTITY", fixture.intTypeNull);
      registerTable(orderItemsTable);

    }

    @Override
    public MockJdbcCatalogReader init() {
